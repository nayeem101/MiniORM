    ...
    where TEntity : class, new()
{
    ...
    public virtual async Task<TEntity?> GetByIdAsync(TKey id, CancellationToken cancellationToken = default)
    {
        ...
        var sql = query.Build();
        using var reader = await Context.ExecuteReaderAsync(sql, query.GetParameterTuples());
    ...
    public virtual async Task<IEnumerable<TEntity>> GetAllAsync(CancellationToken cancellationToken = default)
    {
        ...
        var sql = query.Build();
        using var reader = await Context.ExecuteReaderAsync(sql);
        return EntityMapper.MapAllFromReader<TEntity>(reader);
    }
    ...
    public virtual async Task<int> CountAsync(Expression<Func<TEntity, bool>>? predicate = null, CancellationToken cancellationToken = default)
    {
        ...
        var sql = query.BuildCount();
        var result = await Context.ExecuteScalarAsync(sql, query.GetParameterTuples());
        return Convert.ToInt32(result);
    }
    ...
    public virtual async Task<TEntity> AddAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        var sql = insertQuery.Build();
        var id = await Context.ExecuteScalarAsync(sql, insertQuery.GetParameterTuples());
    ...
    public virtual async Task UpdateAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        var sql = updateQuery.Build();
        await Context.ExecuteNonQueryAsync(sql, updateQuery.GetParameterTuples());
    ...
    public virtual async Task DeleteAsync(TEntity entity, CancellationToken cancellationToken = default)
    {
        ...
        var sql = deleteQuery.Build();
        await Context.ExecuteNonQueryAsync(sql, deleteQuery.GetParameterTuples());
